...
/// copied from flutter source code
/// add onDoubleTab to BottomNavigationBarItem
...
///
/// {@tool dartpad}
/// This example shows a [AlistBottomNavigationBar] as it is used within a [Scaffold]
/// widget. The [AlistBottomNavigationBar] has three [BottomNavigationBarItem]
...
/// {@tool dartpad}
/// This example shows a [AlistBottomNavigationBar] as it is used within a [Scaffold]
/// widget. The [AlistBottomNavigationBar] has four [BottomNavigationBarItem]
...
/// also defined, which changes the background color of [AlistBottomNavigationBar],
...
///
/// {@tool dartpad}
/// This example shows [AlistBottomNavigationBar] used in a [Scaffold] Widget with
...
class AlistBottomNavigationBar extends StatefulWidget {
  ...
  /// The z-coordinate of this [AlistBottomNavigationBar].
  ///
  ...
  /// Defines the layout and behavior of a [AlistBottomNavigationBar].
  ///
  ...
  /// The color of the [AlistBottomNavigationBar] itself.
  ///
  ...
  /// This flag is controlling how [AlistBottomNavigationBar] is going to use
...
class _AlistBottomNavigationBarState extends State<AlistBottomNavigationBar>
  ...
  @override
  void didUpdateWidget(AlistBottomNavigationBar oldWidget) {
...
class _Circle {
  ...
  final _AlistBottomNavigationBarState state;
  final int index;
  final Color color;
